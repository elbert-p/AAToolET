...
{
    class UIStatusBarPoints : UIControl, INetworkController
    {
        ...
        public override void InitializeThis(UIScreen screen)
        {
            ...
            {
                this.pointsLabel = this.pointsPanel.First<UITextBlock>();
                this.pointsBar = this.pointsPanel.First<UIProgressBar>();
                if (this.pointsBar != null)
                {
